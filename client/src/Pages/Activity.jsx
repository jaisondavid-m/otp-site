...
import { getActivity } from '../api/auth.js'
...
function getInitials(title) {
	if (!title) return '??'
	// e.g. "22CH203 - ENGINEERING CHEMISTRY II" → "EC"
...
const STATUS_STYLES = {
	Approved: {
		bg: 'rgba(79,199,144,0.12)',
		color: 'rgba(79,199,144,1)',
	},
	Active: {
	...
	return (
		<div className="activity-card">
			<div className="activity-card-header">
				<div className="activity-initials" style={{ background: 'rgba(79,199,144,0.1)', borderColor: 'rgba(79,199,144,0.3)', color: 'var(--accent)' }}>
					{initials}
				</div>
